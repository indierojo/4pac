...
ufos.forEach(function (u) { return u.draw(context); });
...
function addNewBullet() {
    ...
    var isInSamePosition = function (b) { return b.center.y >= bulletY - 60 && (b.center.x >= bulletXLeft && b.center.x <= bulletXRight); };
